...
func NewPreferredDomainResolver(ctx context.Context, contextLogger log.StructuredLogger, options option.LocalDNSServerOptions) (*PreferredDomainResolver, error) {
