...
var commandServiceInstall = &cobra.Command{
	...
	Run: func(command *cobra.Command, args []string) {
		err := serviceInstall()
		if err != nil {
			log.FatalEvent("cli.error", "install service", log.Err(err))
		}
	},
}
...
var commandServiceUninstall = &cobra.Command{
	...
	Run: func(command *cobra.Command, args []string) {
		...
		if err != nil {
			log.FatalEvent("cli.error", "uninstall service", log.Err(err))
		}
	},
}
...
var commandServiceSetInsecureMode = &cobra.Command{
	...
	Run: func(command *cobra.Command, args []string) {
		...
		if err != nil {
			log.FatalEvent("cli.error", "set insecure mode", log.Err(err))
		}
	},
}
