...
func NewInbound(ctx context.Context, router adapter.Router, logger log.StructuredLogger, tag string, options option.TUICInboundOptions) (adapter.Inbound, error) {
