...
func (b *backendBase) init(ctx context.Context, logger log.StructuredLogger, networkManager adapter.NetworkManager, tag string, options option.BridgeOutboundOptions) error {
