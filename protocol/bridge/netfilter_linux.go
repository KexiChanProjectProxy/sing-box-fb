...
func enableBridgeForwarding(logger log.StructuredLogger, tunName string, inet4 bool, inet6 bool) []sysctlState {
...
func overruleAcceptRA(logger log.StructuredLogger) []sysctlState {
	var restore []sysctlState
...
func setupBridgeNetfilter(logger log.StructuredLogger, tableName string, tunName string, inet6 bool) (bool, error) {
...
// masquerades by mark.
func setupBridgeIptables(logger log.StructuredLogger, tableName string, tunName string, inet6 bool) (bool, error) {
	cleanupBridgeIptables(tableName)
