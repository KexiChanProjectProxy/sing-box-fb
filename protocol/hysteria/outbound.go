...
func NewOutbound(ctx context.Context, router adapter.Router, logger log.StructuredLogger, tag string, options option.HysteriaOutboundOptions) (adapter.Outbound, error) {
